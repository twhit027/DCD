...
<div role="navigation" id="sidebar" >
    ...
    <li>
        ...
        <ul class="nav nav-list collapse" id="accordion-heading-cars">
            <a class="btn btn-primary" role="button" style="width:100%;margin-bottom:2px;" href="category.php?sc=<?php echo @$siteCode; ?>&x=<?php echo @$_GET['x']; ?>" title="Title">Cars(25)</a>
            <a class="btn btn-primary" role="button" style="width:100%;margin-bottom:2px;" href="category.php?sc=<?php echo @$siteCode; ?>&x=<?php echo @$_GET['x']; ?>" title="Title">ATVS(4)</a>
    ...
    <li>
        ...
        <ul class="nav nav-list collapse" id="accordion-heading-animal">
           <a class="btn btn-primary" role="button" style="width:100%;margin-bottom:2px;" href="category.php?sc=<?php echo @$siteCode; ?>&x=<?php echo @$_GET['x']; ?>" title="Title">Cats(25)</a>
           <a class="btn btn-primary" role="button" style="width:100%;margin-bottom:2px;" href="category.php?sc=<?php echo @$siteCode; ?>&x=<?php echo @$_GET['x']; ?>" title="Title">Dogs(4)</a>
        </ul>
