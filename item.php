...
$data .= '<a class="btn btn-primary" href="http://twitter.com/home?status=' . substr($listings['adText'], 0, 120) . '" target="_blank">twitter</a>';
$data .= "<a class='btn btn-primary' href='https://www.facebook.com/sharer/sharer.php?u=http://" . $_SERVER['SERVER_NAME'] . "/item.php?x=" . $listings['id'] . "' target='_blank'>Facebook</a>";
$data .= '<a class="btn btn-primary" href="https://plusone.google.com/_/+1/confirm?hl=en&url=http://' . $_SERVER['SERVER_NAME'] . '/item.php?x=' . $listings['id'] . '" target="_blank">google</a>';
$data .= "</div>";
